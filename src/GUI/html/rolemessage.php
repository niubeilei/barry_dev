...
@session_start();
	...
	if ($nr != 0)
	{
		...
		echo "<p align=\"center\"><font face=\"楷体_GB2312\">角色名：</font><font face=\"楷体_GB2312\" color=#ff0000>$rolename</font></p><br>";
		...
		echo '</table></td></table>';
		echo "<p align=\"center\"><a href=\"pmirole.php?appid=$appid&rolenumb=1\"><img border=\"0\" src=\"image/goback.gif\" width=\"40\" height=\"40\"></a></p>";
            echo '</body></html>';
        }
        $dblink->close();
?>