...
<FORM name="usermanage" METHOD="POST" ACTION="usbkey.php?numb=1">

<table border="0" cellspacing="1" width="100%" id="AutoNumber2" height="400">
  <tr>
  <td>
 <p>
<img border="0" src="image/keyusereg.gif" width="283" height="57"></p>
    ...
    <td width="100%" height="300">　
     ...
     <table border="0" cellspacing="0" width="85%" id="AutoNumber4" height="14" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0">
      ...
      <tr>
        <td width="50%" height="35">
        <p align="right"></td>
        <td width="50%" height="35"><input type="button" value="Key用户注册" name="B1"  onclick="Check_input()" >
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="usbkey.php?numb=1"><img border="0" src="image/goback.gif" width="40" height="40"></a></p>
</td>
      </tr>
...
function Check_input(){
	...
	if(tlen.length>10)
		...
		document.usermanage.action="usbkey.php?numb=1";
