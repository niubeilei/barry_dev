...
class TScan {
 public:
  ...
  static const char* ascii_fingerprint; // = "059961D32A9F4C6CAEBA0C5FE27A5B71";
  static const uint8_t binary_fingerprint[16]; // = {0x05,0x99,0x61,0xD3,0x2A,0x9F,0x4C,0x6C,0xAE,0xBA,0x0C,0x5F,0xE2,0x7A,0x5B,0x71};
