...
public:
	...
	*/
	...
	//
	void addElement(TIXML_STRING elementName, TIXML_STRING elementText);
	//
	// get element text from:
	// <elementName>textValue</elementName>
	//
	bool getElementTextValue(const TIXML_STRING& elementName, TIXML_STRING& textValue);
	bool getElementTextValue(const TIXML_STRING& elementName, bool& textValue);
	bool getElementTextValue(const TIXML_STRING& elementName, int& textValue);
	bool getElementTextValue(const TIXML_STRING& elementName, unsigned int& textValue);
