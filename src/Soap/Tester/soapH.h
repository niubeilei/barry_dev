...
#ifndef SOAP_TYPE_ns__procMsg
#define SOAP_TYPE_ns__procMsg (11)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__procMsg(struct soap*, struct ns__procMsg *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__procMsg(struct soap*, const struct ns__procMsg *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__procMsg(struct soap*, const char*, int, const struct ns__procMsg *, const char*);
SOAP_FMAC3 struct ns__procMsg * SOAP_FMAC4 soap_in_ns__procMsg(struct soap*, const char*, struct ns__procMsg *, const char*);

#ifndef soap_write_ns__procMsg
#define soap_write_ns__procMsg(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__procMsg(soap, data), 0) || soap_put_ns__procMsg(soap, data, "ns:procMsg", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__procMsg(struct soap*, const struct ns__procMsg *, const char*, const char*);

#ifndef soap_read_ns__procMsg
#define soap_read_ns__procMsg(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__procMsg(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__procMsg * SOAP_FMAC4 soap_get_ns__procMsg(struct soap*, struct ns__procMsg *, const char*, const char*);

#define soap_new_ns__procMsg(soap, n) soap_instantiate_ns__procMsg(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__procMsg(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__procMsg * SOAP_FMAC2 soap_instantiate_ns__procMsg(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__procMsg(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__procMsgResponse
#define SOAP_TYPE_ns__procMsgResponse (10)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__procMsgResponse(struct soap*, struct ns__procMsgResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__procMsgResponse(struct soap*, const struct ns__procMsgResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__procMsgResponse(struct soap*, const char*, int, const struct ns__procMsgResponse *, const char*);
SOAP_FMAC3 struct ns__procMsgResponse * SOAP_FMAC4 soap_in_ns__procMsgResponse(struct soap*, const char*, struct ns__procMsgResponse *, const char*);

#ifndef soap_write_ns__procMsgResponse
#define soap_write_ns__procMsgResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__procMsgResponse(soap, data), 0) || soap_put_ns__procMsgResponse(soap, data, "ns:procMsgResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__procMsgResponse(struct soap*, const struct ns__procMsgResponse *, const char*, const char*);

#ifndef soap_read_ns__procMsgResponse
#define soap_read_ns__procMsgResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__procMsgResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__procMsgResponse * SOAP_FMAC4 soap_get_ns__procMsgResponse(struct soap*, struct ns__procMsgResponse *, const char*, const char*);

#define soap_new_ns__procMsgResponse(soap, n) soap_instantiate_ns__procMsgResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__procMsgResponse(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__procMsgResponse * SOAP_FMAC2 soap_instantiate_ns__procMsgResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__procMsgResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#define SOAP_TYPE_PointerToxsd__string (8)
#endif
