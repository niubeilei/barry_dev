...
void covert_hash_to_string( unsigned char *hash, char *hstr )
{
        register int i,j;
...
main()
{
	char *str="good",hash_str[48];
	unsigned char hash[20];
	SHA_Simple(str,strlen(str),hash);
	covert_hash_to_string( hash, hash_str );
	printf("\"good\" hash value : %s !\n", hash_str );
}
