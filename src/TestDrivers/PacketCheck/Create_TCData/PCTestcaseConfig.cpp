...
bool byteStringToStream(std::string byteString, unsigned char *byteStream, unsigned int &len)
{
...
bool byteStreamToString(unsigned char* byteStream, unsigned int len, std::string &byteString)
{
	unsigned int i, j;
	char tmp[3]={0};
