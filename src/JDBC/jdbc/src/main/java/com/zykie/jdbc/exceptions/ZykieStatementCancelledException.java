...
public class ZykieStatementCancelledException extends ZykieNonTransientException {

	static final long serialVersionUID = -8762717748377197378L;

	public ZykieStatementCancelledException(String reason, String SQLState, int vendorCode) {
		super(reason, SQLState, vendorCode);
	}

	public ZykieStatementCancelledException(String reason, String SQLState) {
		super(reason, SQLState);
	}

	public ZykieStatementCancelledException(String reason) {
		super(reason);
	}

	public ZykieStatementCancelledException() {
