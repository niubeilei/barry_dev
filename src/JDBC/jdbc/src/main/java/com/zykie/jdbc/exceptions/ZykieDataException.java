...
public class ZykieDataException extends ZykieNonTransientException {

	static final long serialVersionUID = 4317904269797988676L;

	public ZykieDataException() {
		super();
	}

	public ZykieDataException(String reason, String SQLState, int vendorCode) {
		super(reason, SQLState, vendorCode);
	}

	public ZykieDataException(String reason, String SQLState) {
		super(reason, SQLState);
	}

	public ZykieDataException(String reason) {
		super(reason);
	}
}
