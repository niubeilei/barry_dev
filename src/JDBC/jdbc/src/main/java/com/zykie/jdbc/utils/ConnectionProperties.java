...
public interface ConnectionProperties {
	...
	public abstract void setUtf8OutsideBmpExcludedColumnNamePattern(
			String regexPattern);

	public abstract String getUtf8OutsideBmpIncludedColumnNamePattern();

	public abstract void setUtf8OutsideBmpIncludedColumnNamePattern(
			String regexPattern);
	...
	public abstract void setLoadBalanceBlacklistTimeout(
			int loadBalanceBlacklistTimeout) throws SQLException;
	...
	public abstract void setQueryTimeoutKillsConnection(
	...
	public abstract void setDisabledAuthenticationPlugins(
			String disabledAuthenticationPlugins);

	public abstract String getDisabledAuthenticationPlugins();

	public abstract void setDefaultAuthenticationPlugin(
	...
	public abstract void setDisconnectOnExpiredPasswords(
