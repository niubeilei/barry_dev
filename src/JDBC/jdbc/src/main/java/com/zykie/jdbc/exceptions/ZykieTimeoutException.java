...
public class ZykieTimeoutException extends ZykieTransientException {

	static final long serialVersionUID = -789621240523230339L;

	public ZykieTimeoutException(String reason, String SQLState, int vendorCode) {
		super(reason, SQLState, vendorCode);
	}

	public ZykieTimeoutException(String reason, String SQLState) {
		super(reason, SQLState);
	}

	public ZykieTimeoutException(String reason) {
		super(reason);
	}

	public ZykieTimeoutException() {
