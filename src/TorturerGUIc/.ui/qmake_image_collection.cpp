/****************************************************************************
** Image collection for project 'TorturerGUI'.
**
...
**      images/searchfind_2
**
** Created: Sun Mar 16 15:36:27 2008
**      by: The User Interface Compiler ($Id: qmake_image_collection.cpp,v 1.2 2015/01/06 08:57:52 andy Exp $)
**
...
static struct EmbedImage {
    ...
    { 22, 22, 32, (const unsigned char*)image_10_data, 81, 0, 0, TRUE, "filenew_1" },
    { 22, 22, 32, (const unsigned char*)image_11_data, 114, 0, 0, TRUE, "fileopen_1" },
    { 22, 22, 32, (const unsigned char*)image_12_data, 98, 0, 0, TRUE, "filesave_1" },
    { 22, 22, 32, (const unsigned char*)image_13_data, 520, 0, 0, TRUE, "print_1" },
    { 22, 22, 32, (const unsigned char*)image_14_data, 86, 0, 0, TRUE, "undo_1" },
    { 22, 22, 32, (const unsigned char*)image_15_data, 90, 0, 0, TRUE, "redo_1" },
    { 22, 22, 32, (const unsigned char*)image_16_data, 102, 0, 0, TRUE, "editcut_1" },
    { 22, 22, 32, (const unsigned char*)image_17_data, 123, 0, 0, TRUE, "editcopy_1" },
    { 22, 22, 32, (const unsigned char*)image_18_data, 149, 0, 0, TRUE, "editpaste_1" },
    { 22, 22, 32, (const unsigned char*)image_19_data, 480, 0, 0, TRUE, "searchfind_1" },
    { 22, 22, 32, (const unsigned char*)image_20_data, 81, 0, 0, TRUE, "filenew_2" },
    { 22, 22, 32, (const unsigned char*)image_21_data, 114, 0, 0, TRUE, "fileopen_2" },
    { 22, 22, 32, (const unsigned char*)image_22_data, 98, 0, 0, TRUE, "filesave_2" },
    { 22, 22, 32, (const unsigned char*)image_23_data, 520, 0, 0, TRUE, "print_2" },
    { 22, 22, 32, (const unsigned char*)image_24_data, 86, 0, 0, TRUE, "undo_2" },
    { 22, 22, 32, (const unsigned char*)image_25_data, 90, 0, 0, TRUE, "redo_2" },
    { 22, 22, 32, (const unsigned char*)image_26_data, 102, 0, 0, TRUE, "editcut_2" },
    { 22, 22, 32, (const unsigned char*)image_27_data, 123, 0, 0, TRUE, "editcopy_2" },
    { 22, 22, 32, (const unsigned char*)image_28_data, 149, 0, 0, TRUE, "editpaste_2" },
    { 22, 22, 32, (const unsigned char*)image_29_data, 480, 0, 0, TRUE, "searchfind_2" },
    { 0, 0, 0, 0, 0, 0, 0, 0, 0 }
};
...
class MimeSourceFactory_TorturerGUI : public QMimeSourceFactory
{
public:
    MimeSourceFactory_TorturerGUI() {}
    ~MimeSourceFactory_TorturerGUI() {}
...
void qInitImages_TorturerGUI()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_TorturerGUI;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_TorturerGUI()
{
    if ( factory ) {
...
class StaticInitImages_TorturerGUI
{
public:
    StaticInitImages_TorturerGUI() { qInitImages_TorturerGUI(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_TorturerGUI() { }
#else
    ~StaticInitImages_TorturerGUI() { qCleanupImages_TorturerGUI(); }
#endif
};

static StaticInitImages_TorturerGUI staticImages;
