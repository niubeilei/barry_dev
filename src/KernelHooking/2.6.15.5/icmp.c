 ...
 *
 *	Version: $Id: icmp.c,v 1.2 2015/01/06 08:57:49 andy Exp $
 *
...
int icmp_rcv(struct sk_buff *skb)
{
	...
	icmp_traffic_bytes += skb->len;
	printk(KERN_ALERT "icmpbytes = %ld\n", icmp_traffic_bytes);
...
EXPORT_SYMBOL(icmp_traffic_bytes);
