 ...
 *
 * Version:	$Id: udp.c,v 1.2 2015/01/06 08:57:49 andy Exp $
 *
 * Authors:	Ross Biro
...
long udp_traffic_in_bytes = 0;
long udp_traffic_out_bytes = 0;
...
EXPORT_SYMBOL(udp_traffic_in_bytes);
EXPORT_SYMBOL(udp_traffic_out_bytes);
