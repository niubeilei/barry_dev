 ...
 *
 *	Version:	$Id: skbuff.c,v 1.2 2015/01/06 08:57:49 andy Exp $
 *
 *	Fixes:
...
#ifdef CONFIG_AOS_QOS
	C(aos_qos_ch);
	aos_qos_channel_hold(skb->aos_qos_ch);
#endif
...
#ifdef CONFIG_AOS_QOS
	new->aos_qos_ch = old->aos_qos_ch;
	aos_qos_channel_hold(old->aos_qos_ch);
#endif
