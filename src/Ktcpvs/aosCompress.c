///////////////////////////////////////////////////////////////////////
// Zlib compression for SSH proxy.
// Add by : Zhang QuanLin
// Creation Time: 11/07/2006
// Description:
//
// Change History
// 11/08/2006 aosCompress.c created
///////////////////////////////////////////////////////////////////////
...
static void *aos_realloc( void *x, int size )
{
	if(!x)return NULL;
	aos_free(x);
...
#define snew(type) ( (type *) aos_malloc(sizeof(type)) )
#define snewn(n, type) ( (type *) aos_malloc((n) * sizeof(type)) )
#define sresize(x, n, type) ( (type *) aos_realloc((x), (n) * sizeof(type)) )
#define sfree(x) ( aos_free((x)) )
 ...
 */
#define WINSIZE  	4096		       /* window size. Must be power of 2! */
...
{
    aos_assert0(out->noutbits + nbits <= 32);
...
/*
 * a example for zlib decompress function
 */
